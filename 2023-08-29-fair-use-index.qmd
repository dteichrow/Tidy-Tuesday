---
title: "Tidy Tuesday: Fair Use Index"
format: html
editor: visual
---
...
category_count <- fair_use_cases %>% 
  count(categories) %>% 
  arrange(desc(n))

# Generate the word cloud

wc <- wordcloud2(category_count, size = 0.5, shape = 'circle')

wc
# Save it as a HTML widget
htmlwidgets::saveWidget(wc, "temp_wordcloud.html", selfcontained = FALSE)

# Use webshot to capture this HTML widget and save it as JPEG
webshot("temp_wordcloud.html", "wordcloud.jpg")

# Save HTML widget
saveWidget(wc, "temp_wordcloud.html", selfcontained = FALSE)

# Convert HTML to JPEG
webshot("temp_wordcloud.html", "your_wordcloud.jpeg", delay = 2)

# Delete temporary HTML file
file.remove("temp_wordcloud.html")
